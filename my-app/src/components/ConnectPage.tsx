	...
	return (
		<div className="flex items-center justify-center h-screen bg-black">
			<div className="flex flex-col justify-center items-center">
				...
				<div className="text-white font-bold text-sm p-2 bg-gray-900 border-2 border-red-500 w-fit">Please write your player name to access the site</div>
				<div className="m-3">
					<input type="text-center"
						className="bg-transparent placeholder:text-white text-white text-xs border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
